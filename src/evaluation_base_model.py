...
# -------------------------
model_path = "/home/data/hf_cache/models--malhajar--Mistral-7B-v0.2-meditron-turkish/snapshots/97a28b32c30dc27269ce9da4f9fcc365718244b0/"
...
for sample in tqdm(test_data):
    ...
    option_map = {}  # örn: {"A": "Uyku sırasında kas spazmı", ...}
    ...
    predicted = ""
    for char in response[::-1]:  # sondan başa doğru ara
...
# Sonuçları yaz
# -------------------------
with open("/home/data/evaluation_mc_results.jsonl", "w", encoding="utf-8") as f_out:
    for row in results:
...
print("Saved results to /home/data/evaluation_mc_results.jsonl")